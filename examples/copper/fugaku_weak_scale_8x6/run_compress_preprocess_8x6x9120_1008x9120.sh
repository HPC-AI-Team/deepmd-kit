#!/bin/bash -e
#PJM -L  "node=9120"                          # Number of assign node 8 (1 dimention format)
#PJM -L  "freq=2200"                         
#PJM -L "rscgrp=large"         # Specify resource group
#PJM -L  "elapse=00:20:00"                 # Elapsed time limit 1 hour
#PJM --mpi "max-proc-per-node=8"          # Maximum number of MPI processes created per node
...
export DEEPMD_NUM_THREADS=6
mpiexec lmp_mpi -echo screen -in ../lmp/in.copper_compress_preprocess_1008x9120
