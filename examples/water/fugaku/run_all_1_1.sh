...
likwid-pin -c 0 lmp_serial -echo screen -in ../lmp/in.water_1  >  out.$name
likwid-pin -c 0 lmp_serial -echo screen -in ../lmp/in.water_compress_1  > out.compress-$name
likwid-pin -c 0 lmp_serial -echo screen -in ../lmp/in.water_compress_preprocess_1 > out.compress-preprocess-$name
