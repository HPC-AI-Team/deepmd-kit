#!/bin/bash -e
#PJM -L  "node=19872"                          # Number of assign node 8 (1 dimention format)
#PJM -L  "freq=2200"                         
#PJM -L "rscgrp=large"         # Specify resource group
#PJM -L  "elapse=00:25:00"                 # Elapsed time limit 1 hour
...
mpiexec lmp_mpi -echo screen -in ../lmp/in.water_compress_preprocess_816x19872
