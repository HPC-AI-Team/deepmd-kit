    ...
    const int nnei)
{
  ...
  for (int ii = 0; ii < nloc; ++ii){
    ...
    for (int jj = 0; jj < nnei; jj += svcntd()){
      ...
      svfloat64_t env_0_0 = svld1_gather_u64index_f64(pg1, base, index0);
      svfloat64_t env_0_1 = svld1_gather_u64index_f64(pg1, base, index1);
      svfloat64_t env_0_2 = svld1_gather_u64index_f64(pg1, base, index2);
      svfloat64_t env_1_0 = svld1_gather_u64index_f64(pg1, base, index3);
      svfloat64_t env_1_1 = svld1_gather_u64index_f64(pg1, base, index4);
      svfloat64_t env_1_2 = svld1_gather_u64index_f64(pg1, base, index5);
      svfloat64_t env_2_0 = svld1_gather_u64index_f64(pg1, base, index6);
      svfloat64_t env_2_1 = svld1_gather_u64index_f64(pg1, base, index7);
      svfloat64_t env_2_2 = svld1_gather_u64index_f64(pg1, base, index8);
      svfloat64_t env_3_0 = svld1_gather_u64index_f64(pg1, base, index9);
      svfloat64_t env_3_1 = svld1_gather_u64index_f64(pg1, base, index10);
      svfloat64_t env_3_2 = svld1_gather_u64index_f64(pg1, base, index11);
